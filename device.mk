...
#inherit prebuilt
$(call inherit-product-if-exists, vendor/mediatek/mt6582/device-vendor.mk)
...
PRODUCT_PACKAGES += audio.primary.mt6582
...
PRODUCT_PACKAGES += audio_policy.mt6582
...
PRODUCT_PACKAGES += pcba.ini
PRODUCT_PACKAGES += essential.ini
...
PRODUCT_PACKAGES += sensors.mt6582
...
PRODUCT_PACKAGES += gralloc.mt6582.so
...
PRODUCT_PACKAGES += libmnlp_mt6582
...
PRODUCT_PACKAGES += hwcomposer.mt6582
...
ifeq ($(strip $(MTK_ENABLE_MD5)),yes)
  PRODUCT_PACKAGES += eemcs_mdinit
  PRODUCT_PACKAGES += eemcs_fsd
endif
...
ifeq ($(strip $(MTK_COMBO_SUPPORT)), yes)
  ...
  ifeq ($(strip $(MTK_COMBO_CHIP)), CONSYS_6572)
    PRODUCT_PACKAGES += mt6572_82_patch_e1_0_hdr.bin
    PRODUCT_PACKAGES += mt6572_82_patch_e1_1_hdr.bin
    PRODUCT_PACKAGES += WMT_SOC.cfg
  endif
  ifeq ($(strip $(MTK_COMBO_CHIP)), CONSYS_6582)
    PRODUCT_PACKAGES += mt6572_82_patch_e1_0_hdr.bin
    PRODUCT_PACKAGES += mt6572_82_patch_e1_1_hdr.bin
    PRODUCT_PACKAGES += WMT_SOC.cfg
  endif
...
ifeq ($(strip $(MTK_ENABLE_MD5)),yes)
  ifneq ($(wildcard $(MTK_ROOT_CUSTOM_OUT))/modem/modem_5_2g_n.img),)
    PRODUCT_PACKAGES += modem_5_2g_n.img
    ifeq ($(MTK_MDLOGGER_SUPPORT),yes)
      PRODUCT_PACKAGES += catcher_filter_5_2g_n.bin
    endif
  endif
  ifneq ($(wildcard $(MTK_ROOT_CUSTOM_OUT))/modem/modem_5_wg_n.img),)
    PRODUCT_PACKAGES += modem_5_wg_n.img
    ifeq ($(MTK_MDLOGGER_SUPPORT),yes)
      PRODUCT_PACKAGES += catcher_filter_5_wg_n.bin
    endif
  endif
  ifneq ($(wildcard $(MTK_ROOT_CUSTOM_OUT))/modem/modem_5_tg_n.img),)
    PRODUCT_PACKAGES += modem_5_tg_n.img
    ifeq ($(MTK_MDLOGGER_SUPPORT),yes)
      PRODUCT_PACKAGES += catcher_filter_5_tg_n.bin
    endif
  endif
  ifneq ($(wildcard $(MTK_ROOT_CUSTOM_OUT))/modem/modem_5_lwg_n.img),)
    PRODUCT_PACKAGES += modem_5_lwg_n.img
    ifeq ($(MTK_MDLOGGER_SUPPORT),yes)
      PRODUCT_PACKAGES += catcher_filter_5_lwg_n.bin
    endif
  endif
  ifneq ($(wildcard $(MTK_ROOT_CUSTOM_OUT))/modem/modem_5_ltg_n.img),)
    PRODUCT_PACKAGES += modem_5_ltg_n.img
    ifeq ($(MTK_MDLOGGER_SUPPORT),yes)
      PRODUCT_PACKAGES += catcher_filter_5_ltg_n.bin
    endif
  endif
  ifneq ($(wildcard $(MTK_ROOT_CUSTOM_OUT))/modem/modem_5_sglte_n.img),)
    PRODUCT_PACKAGES += modem_5_sglte_n.img
    ifeq ($(MTK_MDLOGGER_SUPPORT),yes)
      PRODUCT_PACKAGES += catcher_filter_5_sglte_n.bin
    endif
  endif
endif
...
ifeq ($(strip $(MTK_THEMEMANAGER_APP)), yes)
  ...
  PRODUCT_PACKAGES += theme-res-mocha
  PRODUCT_PACKAGES += theme-res-raspberry
...
ifeq ($(strip $(MTK_MDLOGGER_SUPPORT)),yes)
  PRODUCT_PACKAGES += dualmdlogger
  PRODUCT_PACKAGES += mdlogger
  PRODUCT_PACKAGES += emcsmdlogger
endif
...
ifeq (yes,$(strip $(MTK_NFC_SUPPORT)))
  ...
  PRODUCT_COPY_FILES += frameworks/base/nfc-extras/com.android.nfc_extras.xml:system/etc/permissions/com.android.nfc_extras.xml
...
ifeq ($(strip $(MTK_AGPS_APP)), yes)
  ...
  PRODUCT_COPY_FILES += vendor/mediatek/proprietary/frameworks/base/agps/etc/agps_profiles_conf.xml:system/etc/agps_profiles_conf.xml
endif

ifeq ($(strip $(MTK_AGPS_APP)), yes)
  PRODUCT_PACKAGES += mtk_agpsd
  PRODUCT_PACKAGES += libssladp
  PRODUCT_PACKAGES += libagpssupl
endif
...
PRODUCT_COPY_FILES += device/mediatek/mt6582/init.mt6582.rc:root/init.mt6582.rc
PRODUCT_COPY_FILES += device/mediatek/mt6582/factory_init.rc:root/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6582/init.charging.rc:root/init.charging.rc
PRODUCT_COPY_FILES += device/mediatek/mt6582/init.modem.rc:root/init.modem.rc

ifeq ($(strip $(HAVE_AEE_FEATURE)),yes)
	ifneq ($(wildcard device/mediatek/mt6582/init.aee.mtk.rc),)
	PRODUCT_COPY_FILES += device/mediatek/mt6582/init.aee.mtk.rc:root/init.aee.rc
	else
	PRODUCT_COPY_FILES += device/mediatek/mt6582/init.aee.customer.rc:root/init.aee.rc
	endif
endif

ifeq ($(strip $(MTK_SHARED_SDCARD)),yes)
ifeq ($(strip $(MTK_2SDCARD_SWAP)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6582/init.ssd_nomuser.rc:root/init.ssd_nomuser.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6582/init.ssd.rc:root/init.ssd.rc
endif
else
PRODUCT_COPY_FILES += device/mediatek/mt6582/init.no_ssd.rc:root/init.no_ssd.rc
endif

ifeq ($(strip $(MTK_FAT_ON_NAND)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6582/init.fon.rc:root/init.fon.rc
PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt6582.fon:root/fstab.mt6582
endif

PRODUCT_COPY_FILES += device/mediatek/mt6582/init.protect.rc:root/init.protect.rc
PRODUCT_COPY_FILES += device/mediatek/mt6582/init.xlog.rc:root/init.xlog.rc
PRODUCT_COPY_FILES += device/mediatek/mt6582/meta_init.modem.rc:root/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt6582/meta_init.rc:root/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6582/egl.cfg:system/lib/egl/egl.cfg
ifeq ($(strip $(MTK_EMMC_SUPPORT)), yes)
PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt6582:root/fstab.mt6582
else
PRODUCT_COPY_FILES += $(LOCAL_PATH)/fstab.mt6582.nand:root/fstab.mt6582
endif
...
PRODUCT_COPY_FILES += device/mediatek/mt6582/media_codecs.xml:system/etc/media_codecs.xml
PRODUCT_COPY_FILES += device/mediatek/mt6582/media_codecs.xml:system/etc/permissions/media_codecs.xml
PRODUCT_COPY_FILES += device/mediatek/mt6582/mtk_omx_core.cfg:system/etc/mtk_omx_core.cfg

#inherit connectivity combo chip mt66xx serial product packages
# bobule KK aosp workaround
#PRODUCT_MEDIATEK_CONNECTIVITY_HARDWARE := mediatek/config/soc_conn
